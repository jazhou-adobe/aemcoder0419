/* eslint-disable */
/* global WebImporter */
/** Parser for cards-alumni. Base: cards. Source: https://www.unsw.edu.au/. */
export default function parse(element, { document }) {
  // Alumni cards in horizontal-scroll: each card-general has image + title + description
  ...
  var block = WebImporter.Blocks.createBlock(document, { name: 'cards-alumni', cells: cells });
